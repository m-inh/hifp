...
aoc device/hifp_4.cl -o bin_4/hifp.aocx -board=pac_a10
echo "4 done"

aoc device/hifp_2.cl -o bin_2/hifp.aocx -board=pac_a10
echo "2 done"

aoc device/hifp_1.cl -o bin_1/hifp.aocx -board=pac_a10
echo "1 done"
